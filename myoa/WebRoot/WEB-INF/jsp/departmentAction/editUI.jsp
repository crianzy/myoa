		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> 部门信息
			</div>
				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<s:select name="parentId" list="departmentTreeStr" cssClass="SelectStyle"
						...
						<tr>
							<td>部门名称</td>
							<td><input type="text" name="departmentName" class="InputStyle" value="${department.departmentName }"/> *</td>
						</tr>
						<tr>
							<td>职能说明</td>
							<td><textarea name="description" class="TextareaStyle">${department.description }</textarea>
							</td>
						</tr>
					</table>
				</div>
