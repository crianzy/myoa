		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> 用户信息
			</div>
		...
		<form action="userAction_edit" method="post">
			...
			<div class="ItemBlock_Title1">
				...
				<div class="ItemBlock_Title1">
					<img border="0" width="4" height="7"
						src="style/blue/images/item_point.gif" /> 用户信息
				</div>
			</div>
			...
			<div class="ItemBlockBorder">
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<s:select name="departmentId" list="departmentTreeStr" cssClass="SelectStyle"
									listKey="id" listValue="departmentName" headerKey="" headerValue="请选择">
								</s:select>
						...
						<tr>
							<td>性别</td>
							<td>
								<%-- <s:radio name="gender" list="#{'男':'女'.'男':'女' }"></s:radio> --%>
								<%
									String genderStr = (String) ActionContext.getContext()
											.getValueStack().findValue("gender");
								%> <input type="RADIO" name="gender" value="男" id="male"
								<%if ("男".equals(genderStr)) {
				out.print("checked='checked'");
			}%> /><label
								for="male">男</label> <input type="RADIO" name="gender" value="女"
								id="female"
				...
				out.print("checked='checked'");
						...
						<tr>
							<td>联系电话</td>
							<td><input type="text" name="phoneNumber" class="InputStyle"
						...
						<tr>
							<td>备注</td>
							<td><textarea name="description" class="TextareaStyle">${description }</textarea>
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="ItemBlock_Title1">
				...
				<div class="ItemBlock_Title1">
					<img border="0" width="4" height="7"
						src="style/blue/images/item_point.gif" /> 岗位设置
				</div>
			</div>
			...
			<div class="ItemBlockBorder">
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							<td width="100">岗位</td>
							<td><s:select name="roleIds" list="#roleList"
									multiple="true" size="10" cssClass="SelectStyle" listKey="id"
									listValue="rolename">
								</s:select> <!-- <select name="roleIdList" multiple="true" size="10"
								class="SelectStyle">
